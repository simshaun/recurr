...
return [
    ...
    'on' => 'p�', // e.g. every day on Tuesday, Wednesday and Friday
    'the_for_monthday' => 'den', // e.g. monthly on Tuesday the 1st
    'the_for_weekday' => 'den', // e.g. monthly on the 4th Monday
    'on the' => 'p� den', // e.g. every year on the 1st and 200th day
    'of_the_month' => 'i m�neden', // e.g. every year on the 2nd or 3rd of the month
    'every %count% years' => 'hvert %count% �r',
    'every year' => '�rlig',
    'every_month_list' => 'hver', // e.g. every January, May and August
    'every %count% months' => 'hver %count% m�ned',
    'every month' => 'm�nedlig',
